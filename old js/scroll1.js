...
//        // SEARCH Check the initial Poistion of the Sticky Header
		...
		$(window).scroll(function(){
			$('#meter').text('scrollTop:'+$(window).scrollTop()+'     logo outerHeight: '+logoHeight+'     logo height: '+logoHeight2+'  fillerHeight:'+fillerHeight);
...
//					
			...
			if( $(window).scrollTop() > stickyHeaderTop-93 ) {
